...
{
    public const SERVER_STATUS_IN_TRANS = 0x1;
    // a transaction is active
    public const SERVER_STATUS_AUTOCOMMIT = 0x2;
    // auto-commit is enabled
    public const SERVER_MORE_RESULTS_EXISTS = 0x8;
    ...
    public const SERVER_STATUS_DB_DROPPED = 0x100;
    public const SERVER_STATUS_NO_BACKSLASH_ESCAPES = 0x200;
    public const SERVER_STATUS_METADATA_CHANGED = 0x400;
    public const SERVER_QUERY_WAS_SLOW = 0x800;
...
{
    public const SESSION_TRACK_SYSTEM_VARIABLES = 0x0;
    public const SESSION_TRACK_SCHEMA = 0x1;
    public const SESSION_TRACK_STATE_CHANGE = 0x2;
    public const SESSION_TRACK_GTIDS = 0x3;
    public const SESSION_TRACK_TRANSACTION_CHARACTERISTICS = 0x4;
    public const SESSION_TRACK_TRANSACTION_STATE = 0x5;
}
/** @internal */
...
REGEX;
    ...
    private const CLIENT_COMPRESS = 0x20;
    private const CLIENT_LOCAL_INFILE = 0x80;
    ...
    private const CLIENT_MULTI_STATEMENTS = 0x10000;
    private const CLIENT_MULTI_RESULTS = 0x20000;
    private const CLIENT_PS_MULTI_RESULTS = 0x40000;
    private const CLIENT_PLUGIN_AUTH = 0x80000;
    private const CLIENT_CONNECT_ATTRS = 0x100000;
    private const CLIENT_SESSION_TRACK = 0x800000;
    private const CLIENT_PLUGIN_AUTH_LENENC_CLIENT_DATA = 0x200000;
    private const CLIENT_DEPRECATE_EOF = 0x1000000;
    private const OK_PACKET = 0x0;
    private const EXTRA_AUTH_PACKET = 0x1;
