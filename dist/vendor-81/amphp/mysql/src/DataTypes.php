...
{
    public const MYSQL_TYPE_DECIMAL = 0x0;
    public const MYSQL_TYPE_TINY = 0x1;
    public const MYSQL_TYPE_SHORT = 0x2;
    public const MYSQL_TYPE_LONG = 0x3;
    public const MYSQL_TYPE_FLOAT = 0x4;
    public const MYSQL_TYPE_DOUBLE = 0x5;
    public const MYSQL_TYPE_NULL = 0x6;
    public const MYSQL_TYPE_TIMESTAMP = 0x7;
    public const MYSQL_TYPE_LONGLONG = 0x8;
    public const MYSQL_TYPE_INT24 = 0x9;
    public const MYSQL_TYPE_DATE = 0xa;
    public const MYSQL_TYPE_TIME = 0xb;
    public const MYSQL_TYPE_DATETIME = 0xc;
    public const MYSQL_TYPE_YEAR = 0xd;
    public const MYSQL_TYPE_NEWDATE = 0xe;
    public const MYSQL_TYPE_VARCHAR = 0xf;
    ...
    {
        return \substr($str, 0, $len = \strpos($str, "\x00"));
    }
