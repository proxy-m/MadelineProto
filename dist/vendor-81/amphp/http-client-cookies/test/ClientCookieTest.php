...
class ClientCookieTest extends CookieTest
{
    ...
    public function setUp() : void
    {
        ...
        $this->client = (new HttpClientBuilder())->usingPool(new UnlimitedConnectionPool(new DefaultConnectionFactory(new StaticConnector($this->address, connector()))))->interceptNetwork(new CookieInterceptor($this->jar))->build();
    }
    /**
