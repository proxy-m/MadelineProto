...
final class FileBody implements RequestBody
{
    ...
    {
        $handlePromise = \function_exists('Amp\\File\\openFile') ? openFile($this->path, "r") : open($this->path, "r");
    ...
    {
        return \function_exists('Amp\\File\\getSize') ? getSize($this->path) : size($this->path);
    }
}