...
final class ConnectionConfig extends SqlConnectionConfig
{
    ...
    public const SSL_MODES = ['disable', 'allow', 'prefer', 'require', 'verify-ca', 'verify-full'];
    /** @var string|null */
    ...
    public function __construct(string $host, int $port = self::DEFAULT_PORT, string $user = null, string $password = null, string $database = null)
    {
