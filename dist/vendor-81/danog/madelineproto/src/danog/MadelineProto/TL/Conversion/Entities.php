...
final class Entities
{
     ...
     */
    private function setEntitie(int $type, array $array = [], string $intag = "", &$i = 0) : array|null|bool
    {
     ...
     * @return string
     */
    public function entitiesToHtml(string $text, array|object $entities = [], bool $specialchars = true) : string
    {
        $this->setOffset = [];
        $this->setOffset2 = [];
        ...
        $htmlext = "";
        $deltag = ["&" . "\x00" . "a" . "\x00" . "m" . "\x00" . "p" . "\x00" . ";" . "\x00" . "", "&" . "\x00" . "l" . "\x00" . "t" . "\x00" . ";" . "\x00" . "", "&" . "\x00" . "g" . "\x00" . "t" . "\x00" . ";" . "\x00" . ""];
        $deltag2 = ['/&\\000/', '/\\<\\000/', '/\\>\\000/'];
     ...
     * @return string
     */
    public function entitiesToMarkdownV1(string $text, object|array $entities = [], bool $slashmarkdown = true) : string
    {
        $this->setOffset = [];
        $this->setOffset2 = [];
        $utf16 = $this->encode($text);
        ...
        $htmlext = "";
        $deltag = ["\\" . "\x00" . "_" . "\x00" . "", "\\" . "\x00" . "*" . "\x00" . "", "\\" . "\x00" . "`" . "\x00" . "", "\\" . "\x00" . "[" . "\x00" . ""];
     ...
     * @return string
     */
    public function entitiesToMarkdown(string $text, object|array $entities = [], bool $slashmarkdown = true) : string
    {
        $this->setOffset = [];
        $this->setOffset2 = [];
        $utf16 = $this->encode($text);
        ...
        $htmlext = "";
        $deltag = ["\\" . "\x00" . "_" . "\x00" . "", "\\" . "\x00" . "*" . "\x00" . "", "\\" . "\x00" . "[" . "\x00" . "", "\\" . "\x00" . "]" . "\x00" . "", "\\" . "\x00" . "(" . "\x00" . "", "\\" . "\x00" . ")" . "\x00" . "", "\\" . "\x00" . "~" . "\x00" . "", "\\" . "\x00" . "" . "\x00" . "", "\\" . "\x00" . ">" . "\x00" . "", "\\" . "\x00" . "#" . "\x00" . "", "\\" . "\x00" . "+" . "\x00" . "", "\\" . "\x00" . "-" . "\x00" . "", "\\" . "\x00" . "=" . "\x00" . "", "\\" . "\x00" . "|" . "\x00" . "", "\\" . "\x00" . "{" . "\x00" . "", "\\" . "\x00" . "}" . "\x00" . "", "\\" . "\x00" . "." . "\x00" . "", "\\" . "\x00" . "!" . "\x00" . ""];
