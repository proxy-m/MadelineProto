...
class Integer extends Base
{
    ...
    private static function polynomialMultiply($x, $y)
    {
        ...
        $m = $length >> 1;
        $x1 = \Phabel\Target\Php80\Polyfill::substr($x, 0, -$m);
        $x0 = \Phabel\Target\Php80\Polyfill::substr($x, -$m);
        $y1 = \Phabel\Target\Php80\Polyfill::substr($y, 0, -$m);
        $y0 = \Phabel\Target\Php80\Polyfill::substr($y, -$m);
