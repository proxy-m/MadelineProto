...
class GMP extends Engine
{
    ...
    */
    public function toBits($twos_compliment = false)
    {
        ...
        if ($this->precision > 0) {
            $bits = \Phabel\Target\Php80\Polyfill::substr($bits, -$this->precision);
        }
    ...
    public function toBytes($twos_compliment = false)
    {
        ...
        return $this->precision > 0 ? \Phabel\Target\Php80\Polyfill::substr(str_pad($temp, $this->precision >> 3, chr(0), STR_PAD_LEFT), -($this->precision >> 3)) : ltrim($temp, chr(0));
    }
    /**
