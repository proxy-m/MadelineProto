...
final class Pool extends ConnectionPool implements Link
{
     ...
     */
    public function __construct(ConnectionConfig $config, int $maxConnections = self::DEFAULT_MAX_CONNECTIONS, int $idleTimeout = self::DEFAULT_IDLE_TIMEOUT, bool $resetConnections = true, ?Connector $connector = NULL)
    {
