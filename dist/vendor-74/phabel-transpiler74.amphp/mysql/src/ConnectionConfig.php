...
final class ConnectionConfig extends SqlConnectionConfig
{
    ...
    public const BIN_CHARSET = 45;
    // utf8mb4_general_ci
    public const KEY_MAP = array('hostname' => 'host', 'username' => 'user', 'pass' => 'password', 'database' => 'db', 'dbname' => 'db', 'compress' => 'compression', 'useCompression' => 'compression', 'cs' => 'charset', 'localInfile' => 'local-infile');
     ...
     *
     */
    public function __construct(string $host, int $port = 3306, string $user = NULL, string $password = NULL, string $database = NULL, ConnectContext $context = NULL, string $charset = 'utf8mb4', string $collate = 'utf8mb4_general_ci', bool $useCompression = false, string $key = '', bool $useLocalInfile = false)
    {
     ...
     *
     */
    public function withCharset(string $charset = 'utf8mb4', string $collate = 'utf8mb4_general_ci') : self
    {
        $new = clone $this;
        $new->charset = $charset;
        $new->collate = $collate;
