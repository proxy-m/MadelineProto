...
final class Rfc7692Compression implements CompressionContext
{
    ...
    private const EMPTY_BLOCK = '' . "\x00" . '' . "\x00" . 'ÿÿ';
    /**
    ...
    public function compress(string $data, bool $isFinal) : string
    {
        ...
        if ($isFinal && \Phabel\Target\Php80\Polyfill::substr($data, -4) === self::EMPTY_BLOCK) {
            $data = \Phabel\Target\Php80\Polyfill::substr($data, 0, -4);
        }
        return $data;
    }
}