...
abstract class PKCS8 extends Progenitor
{
     ...
     * @access private
     */
    const OID_NAME = array(0 => 'id-ecPublicKey', 1 => 'id-Ed25519', 2 => 'id-Ed448');
    /**
     * OID Value
     *
     * @var string
     * @access private
     */
    const OID_VALUE = array(0 => '1.2.840.10045.2.1', 1 => '1.3.101.112', 2 => '1.3.101.113');
    /**
    ...
    private static function loadEdDSA(array $key)
    {
        ...
        if (isset($key['privateKey'])) {
            ...
            if (\Phabel\Target\Php80\Polyfill::substr($key['privateKey'], 0, 2) != "\x04 ") {
                throw new \RuntimeException('The first two bytes of the private key field should be 0x0420');
            }
            $components['dA'] = $components['curve']->extractSecret(\Phabel\Target\Php80\Polyfill::substr($key['privateKey'], 2));
        }
     ...
     * @return string
     */
    public static function savePrivateKey(BigInteger $privateKey, BaseCurve $curve, array $publicKey, $password = '', array $options = array())
    {
        self::initialize_static_variables();
        if ($curve instanceof MontgomeryCurve) {
            throw new UnsupportedCurveException('Montgomery Curves are not supported');
