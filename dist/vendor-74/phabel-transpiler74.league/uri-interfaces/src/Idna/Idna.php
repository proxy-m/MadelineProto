...
final class Idna
{
    ...
    public const ERROR_TRAILING_HYPHEN = 16;
    public const ERROR_HYPHEN_3_4 = 32;
    public const ERROR_LEADING_COMBINING_MARK = 64;
    public const ERROR_DISALLOWED = 128;
    public const ERROR_PUNYCODE = 256;
    public const ERROR_LABEL_HAS_DOT = 512;
    public const ERROR_INVALID_ACE_LABEL = 1024;
    public const ERROR_BIDI = 2048;
    public const ERROR_CONTEXTJ = 4096;
    public const ERROR_CONTEXTO_PUNCTUATION = 8192;
    public const ERROR_CONTEXTO_DIGITS = 16384;
    /**
     * IDNA default options.
     */
    public const IDNA2008_ASCII = 30;
    public const IDNA2008_UNICODE = 46;
    /**
     * @codeCoverageIgnore
     */
