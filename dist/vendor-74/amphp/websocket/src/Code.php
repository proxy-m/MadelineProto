...
final class Code
{
    ...
    {
        return [self::NORMAL_CLOSE => 'NORMAL_CLOSE', self::GOING_AWAY => 'GOING_AWAY', self::PROTOCOL_ERROR => 'PROTOCOL_ERROR', self::UNACCEPTABLE_TYPE => 'UNACCEPTABLE_TYPE', self::NONE => 'NONE', self::ABNORMAL_CLOSE => 'ABNORMAL_CLOSE', self::INCONSISTENT_FRAME_DATA_TYPE => 'INCONSISTENT_FRAME_DATA_TYPE', self::POLICY_VIOLATION => 'POLICY_VIOLATION', self::MESSAGE_TOO_LARGE => 'MESSAGE_TOO_LARGE', self::EXPECTED_EXTENSION_MISSING => 'EXPECTED_EXTENSION_MISSING', self::UNEXPECTED_SERVER_ERROR => 'UNEXPECTED_SERVER_ERROR', self::SERVICE_RESTARTING => 'SERVICE_RESTARTING', self::TRY_AGAIN_LATER => 'TRY_AGAIN_LATER', self::BAD_GATEWAY => 'BAD_GATEWAY', self::TLS_HANDSHAKE_FAILURE => 'TLS_HANDSHAKE_FAILURE'][$code] ?? null;
    }
    /**
