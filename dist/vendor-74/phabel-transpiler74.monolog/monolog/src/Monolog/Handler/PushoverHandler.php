...
class PushoverHandler extends SocketHandler
{
    ...
    */
    public function __construct(string $token, $users, ?string $title = NULL, $level = 500, bool $bubble = true, bool $useSSL = true, $highPriorityLevel = 500, $emergencyLevel = 600, int $retry = 30, int $expire = 25200, bool $persistent = false, float $timeout = 0.0, float $writingTimeout = 10.0, ?float $connectionTimeout = NULL, ?int $chunkSize = NULL)
    {
