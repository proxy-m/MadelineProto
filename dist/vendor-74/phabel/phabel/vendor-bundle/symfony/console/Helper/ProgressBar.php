...
final class ProgressBar
{
     ...
     */
    public function __construct(OutputInterface $output, int $max = 0, float $minSecondsBetweenRedraws = 0.04)
    {
    ...
    */
    ...
    private function setRealFormat(string $format)
    {
        ...
        $this->formatLineCount = \Phabel\Target\Php80\Polyfill::substr_count($this->format, "\n");
    }
    /**
