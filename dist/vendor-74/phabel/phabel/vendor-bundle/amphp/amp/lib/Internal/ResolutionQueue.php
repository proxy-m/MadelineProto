...
namespace PhabelVendor\Amp\Internal;

use PhabelVendor\Amp\Coroutine;
use PhabelVendor\Amp\Loop;
use PhabelVendor\Amp\Promise;
use PhabelVendor\React\Promise\PromiseInterface as ReactPromise;
/**
...
class ResolutionQueue
{
     ...
     *
     * @psalm-param (null | callable((\Throwable | null) , mixed ): (Promise | \React\Promise\PromiseInterface | \Generator<mixed, (Promise | \React\Promise\PromiseInterface | array<array-key, (Promise | \React\Promise\PromiseInterface)>), mixed, mixed> | null) | callable((\Throwable | null) , mixed ): void) $callback
     */
     ...
     *
     * @psalm-param (callable((\Throwable | null) , mixed ): (Promise | \React\Promise\PromiseInterface | \Generator<mixed, (Promise | \React\Promise\PromiseInterface | array<array-key, (Promise | \React\Promise\PromiseInterface)>), mixed, mixed> | null) | callable((\Throwable | null) , mixed ): void) $callback
     *
     * @return void
     */
