...
class InternalDoc extends APIFactory
{
    ...
    */
     ...
     * @return \Amp\Promise
     */
    public function connect(string $config, array $extra = array())
    {
    ...
    */
     ...
     * @return \Amp\Promise
     */
    public function loop(callable $func, array $extra = array())
    {
     ...
     * @return \Amp\Promise
     */
    public function methodCall(string $methodName, array $args = array(), array $aargs = array(), array $extra = array())
    {
