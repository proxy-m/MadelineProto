...
final class Entities
{
    ...
    */
    ...
    {
        return (function ($phabel_b99f153be5d8ae62) use(&$mode, &$text) {
            if ($phabel_b99f153be5d8ae62 === 'html') {
                return $this->htmlToEntities($text);
            } elseif ($phabel_b99f153be5d8ae62 === 'markdown') {
                return $this->markdownToEntities($text);
            } elseif ($phabel_b99f153be5d8ae62 === 'markdownv2') {
                return $this->markdownToEntities($text);
            } elseif ($phabel_b99f153be5d8ae62 === 'markdownv1') {
                return $this->markdownV1ToEntities($text);
            } elseif ($phabel_b99f153be5d8ae62 === 'markdownhtml') {
                return $this->markdownhtmlToEntities($text);
            } elseif ($phabel_b99f153be5d8ae62 === 'markdownv2html') {
                return $this->markdownhtmlToEntities($text);
            } elseif ($phabel_b99f153be5d8ae62 === 'markdownv1html') {
