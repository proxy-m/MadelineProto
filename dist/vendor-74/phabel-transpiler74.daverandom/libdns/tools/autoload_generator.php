...
\Phabel\Target\Php80\Polyfill::error_reporting(0);
...
foreach ($iterator as $item) {
    if ($item->isFile() && $item->getFilename() !== 'autoload.php' && strtolower($item->getExtension()) === 'php') {
        $classPath = \Phabel\Target\Php80\Polyfill::substr($item->getPath() . '\\' . $item->getBasename('.' . $item->getExtension()), $stripLength);
