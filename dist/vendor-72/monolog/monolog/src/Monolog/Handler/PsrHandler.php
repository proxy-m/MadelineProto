...
class PsrHandler extends AbstractHandler implements FormattableHandlerInterface
{
     ...
     */
    public function __construct($logger, $level = 100, bool $bubble = true)
    {
        if (!$logger instanceof LoggerInterface) {
            throw new \TypeError(__METHOD__ . '(): Argument #1 ($logger) must be of type LoggerInterface, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($logger) . ' given, called in ' . \Phabel\Plugin\TypeHintReplacer::trace());
        }
