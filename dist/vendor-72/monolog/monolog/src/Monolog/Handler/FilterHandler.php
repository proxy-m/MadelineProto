...
class FilterHandler extends Handler implements ProcessableHandlerInterface, ResettableInterface, FormattableHandlerInterface
{
     ...
     */
    public function __construct($handler, $minLevelOrList = 100, $maxLevel = 600, bool $bubble = true)
    {
     ...
     * @phpstan-param (Level | LevelName | LogLevel::*) $maxLevel
     */
    public function setAcceptedLevels($minLevelOrList = 100, $maxLevel = 600) : self
    {
        if (is_array($minLevelOrList)) {
            ...
            $acceptedLevels = array_values(\Phabel\Target\Php74\Polyfill::array_filter(Logger::getLevels(), function ($level) use($minLevelOrList, $maxLevel) {
