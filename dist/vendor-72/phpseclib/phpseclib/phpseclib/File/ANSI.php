...
class ANSI
{
            ...
            if (strlen($this->ansi)) {
                ...
                switch ($this->ansi) {
                    ...
                    case "\x1b[J":
                        ...
                        $this->history = array_merge($this->history, array_slice(\Phabel\Target\Php74\Polyfill::array_splice($this->screen, $this->y + 1), 0, $this->old_y));
                        $this->screen = array_merge($this->screen, array_fill($this->y, $this->max_y, ''));
                        $this->history_attrs = array_merge($this->history_attrs, array_slice(\Phabel\Target\Php74\Polyfill::array_splice($this->attrs, $this->y + 1), 0, $this->old_y));
                    ...
                    case "\x1b[K":
                        ...
                        $this->screen[$this->y] = \Phabel\Target\Php80\Polyfill::substr($this->screen[$this->y], 0, $this->x);
                        \Phabel\Target\Php74\Polyfill::array_splice($this->attrs[$this->y], $this->x + 1, $this->max_x - $this->x, array_fill($this->x, $this->max_x - ($this->x - 1), $this->base_attr_cell));
                        break;
                    case "\x1b[2K":
                        // Clear entire line
            ...
            switch ($source[$i]) {
                ...
                case "\x08":
                    ...
                    if ($this->x) {
                        ...
                        $this->screen[$this->y] = \Phabel\Target\Php80\Polyfill::substr_replace($this->screen[$this->y], $source[$i], $this->x, 1);
                    }
                    break;
                case "\x0f":
                    // shift
                ...
                case "\x1b":
                    ...
                    $this->tokenization[count($this->tokenization) - 1] = \Phabel\Target\Php80\Polyfill::substr($this->tokenization[count($this->tokenization) - 1], 0, -1);
    ...
    private function getScreenHelper()
    {
        ...
        $output = \Phabel\Target\Php80\Polyfill::substr($output, 0, -2);
