...
function hasColorSupport() : bool
{
    ...
    if ($os === 'win') {
        ...
        return \function_exists('sapi_windows_vt100_support') && @\sapi_windows_vt100_support(\STDOUT) || $windowsVersion === '10.0.10586' || false !== \getenv('ANSICON') || 'ON' === \getenv('ConEmuANSI') || 'xterm' === \getenv('TERM');
    }
