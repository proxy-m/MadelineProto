...
use PhabelVendor\PhpParser\ConstExprEvaluator;
...
abstract class Tools
{
     ...
     * @return Node
     */
    public static function replaceType(Node $node, string $class, array $propertyMap = array()) : Node
    {
        if ($propertyMap) {
     ...
     * @return void
     */
    public static function replaceTypeInPlace(Node &$node, string $class, array $propertyMap = array()) : void
    {
    ...
    public static function cloneWithTrait(object $obj, string $trait) : object
    {
        ...
        if (isset($memoized["{$trait} {$extend}"])) {
            ...
            $newObj = ($phabel_30cafbb631f6319a = $memoized["{$trait} {$extend}"]) || \true ? new $phabel_30cafbb631f6319a() : \false;
        } else {
