...
class Version
{
     ...
     * Changelog.
     */
    public const CHANGELOG = array(0 => '<bold>Welcome! You can now use PHP 8 features in your code.</bold>

<bold>Config recap:</bold>
<bold>✅</bold> Source PHP version: <phabel>8.0</phabel>
<bold>✅</bold> Target PHP version: <phabel>auto</phabel> <bold>(7.1|7.2|7.3|7.4|8.0)</bold>
