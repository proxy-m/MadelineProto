 ...
 */
namespace PhabelVendor\Symfony\Component\Console\Exception;
...
class CommandNotFoundException extends \InvalidArgumentException implements ExceptionInterface
{
     ...
     */
    public function __construct($message, $alternatives = array(), $code = 0, \Throwable $previous = NULL)
    {
        ...
        if (!\is_array($alternatives)) {
            throw new \TypeError(__METHOD__ . '(): Argument #2 ($alternatives) must be of type array, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($alternatives) . ' given, called in ' . \Phabel\Plugin\TypeHintReplacer::trace());
        }
        if (!\is_int($code)) {
