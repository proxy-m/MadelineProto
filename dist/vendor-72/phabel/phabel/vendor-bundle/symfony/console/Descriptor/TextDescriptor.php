...
class TextDescriptor extends Descriptor
{
    ...
    protected function describeApplication(Application $application, array $options = array())
    {
        ...
        if (isset($options['raw_text']) && $options['raw_text']) {
            ...
            foreach ($namespaces as $namespace) {
                $namespace['commands'] = \Phabel\Target\Php74\Polyfill::array_filter($namespace['commands'], function ($name) use($commands) {
    ...
    {
        $this->write(isset($options['raw_text']) && $options['raw_text'] ? \Phabel\Target\Php80\Polyfill::strip_tags($content) : $content, isset($options['raw_output']) ? !$options['raw_output'] : \true);
    }
    /**
