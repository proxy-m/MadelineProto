 ...
 */
namespace PhabelVendor\Symfony\Component\Console\Style;
...
use PhabelVendor\Symfony\Component\Console\Helper\SymfonyQuestionHelper;
use PhabelVendor\Symfony\Component\Console\Helper\Table;
use PhabelVendor\Symfony\Component\Console\Helper\TableCell;
use PhabelVendor\Symfony\Component\Console\Helper\TableSeparator;
...
use PhabelVendor\Symfony\Component\Console\Output\TrimmedBufferOutput;
use PhabelVendor\Symfony\Component\Console\Question\ChoiceQuestion;
use PhabelVendor\Symfony\Component\Console\Question\ConfirmationQuestion;
...
class SymfonyStyle extends OutputStyle
{
    ...
    */
    ...
    {
        $chars = \Phabel\Target\Php80\Polyfill::substr(\str_replace(\PHP_EOL, "\n", $this->bufferedOutput->fetch()), -2);
        if (!isset($chars[0])) {
            $this->newLine();
        ...
        $this->newLine(2 - \Phabel\Target\Php80\Polyfill::substr_count($chars, "\n"));
    }
    /**
     *
     */
    ...
    private function createBlock(iterable $messages, string $type = NULL, string $style = NULL, string $prefix = ' ', bool $padding = false, bool $escape = false) : array
    {
        ...
        if ($padding && $this->isDecorated()) {
            $firstLineIndex = 1;
            \Phabel\Target\Php73\Polyfill::array_unshift($lines, '');
            $lines[] = '';
        }
