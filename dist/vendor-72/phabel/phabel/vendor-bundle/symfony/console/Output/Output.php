...
abstract class Output implements OutputInterface
{
     ...
     */
    public function __construct(?int $verbosity = self::VERBOSITY_NORMAL, $decorated = false, OutputFormatterInterface $formatter = NULL)
    {
        ...
        foreach ($messages as $message) {
            switch ($type) {
                ...
                case OutputInterface::OUTPUT_PLAIN:
                    $message = \Phabel\Target\Php80\Polyfill::strip_tags($this->formatter->format($message));
                    break;
            }
