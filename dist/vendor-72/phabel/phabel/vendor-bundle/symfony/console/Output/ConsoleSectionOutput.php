...
class ConsoleSectionOutput extends StreamOutput
{
     ...
     */
    public function __construct($stream, &$sections, int $verbosity, bool $decorated, OutputFormatterInterface $formatter)
    {
        ...
        \Phabel\Target\Php73\Polyfill::array_unshift($sections, $this);
    ...
    public function clear(int $lines = NULL)
    {
        ...
        if ($lines) {
            \Phabel\Target\Php74\Polyfill::array_splice($this->content, -($lines * 2));
