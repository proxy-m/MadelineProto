...
class PhpDocNode implements Node
{
    ...
    {
        return \Phabel\Target\Php74\Polyfill::array_filter($this->children, static function (PhpDocChildNode $child) : bool {
    ...
    {
        return \Phabel\Target\Php74\Polyfill::array_filter($this->getTags(), static function (PhpDocTagNode $tag) use($tagName) : bool {
    ...
    {
        return \Phabel\Target\Php74\Polyfill::array_filter(array_column($this->getTagsByName($tagName), 'value'), static function (PhpDocTagValueNode $value) : bool {
    ...
    {
        return \Phabel\Target\Php74\Polyfill::array_filter(array_column($this->getTagsByName('@deprecated'), 'value'), static function (PhpDocTagValueNode $value) : bool {
