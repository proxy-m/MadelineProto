...
*
* @template TGenerator of (TGeneratorReturn | Promise<TGeneratorPromise>)
* @template T of (TReturn | Promise<TPromise> | \Generator<mixed, mixed, mixed, TGenerator>)
*
* @formatter :off
*
...
namespace PhabelVendor\Amp\Promise;

use PhabelVendor\Amp\Deferred;
use PhabelVendor\Amp\Loop;
use PhabelVendor\Amp\MultiReasonException;
...
use function PhabelVendor\Amp\Internal\createTypeError;
/**
...
*
* @template TPromise
* @template T of (Promise<TPromise> | ReactPromise)
*
...
namespace PhabelVendor\Amp\Iterator;

use PhabelVendor\Amp\Delayed;
use PhabelVendor\Amp\Emitter;
use PhabelVendor\Amp\Iterator;
use PhabelVendor\Amp\Producer;
use PhabelVendor\Amp\Promise;
use function PhabelVendor\Amp\call;
use function PhabelVendor\Amp\coroutine;
use function PhabelVendor\Amp\Internal\createTypeError;
/**
