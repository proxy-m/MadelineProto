...
use PhabelVendor\Amp\Parallel\Sync\ExitFailure;
use PhabelVendor\Amp\Parallel\Sync\ExitResult;
use PhabelVendor\Amp\Parallel\Sync\ExitSuccess;
use PhabelVendor\Amp\Parallel\Sync\SerializationException;
        ...
        $future = $this->runtime->run(static function (int $id, string $uri, string $key, string $path, array $argv) : int {
            ...
            try {
                ...
                try {
                    ...
                    $argc = \Phabel\Target\Php73\Polyfill::array_unshift($argv, $path);
                    try {
