...
class String_ extends Scalar
{
    ...
    public static function parse(string $str, bool $parseUnicodeEscape = true) : string
    {
        ...
        if ('\'' === $str[$bLength]) {
            return \str_replace(['\\\\', '\\\''], ['\\', '\''], \Phabel\Target\Php80\Polyfill::substr($str, $bLength + 1, -1));
        } else {
            return self::parseEscapeSequences(\Phabel\Target\Php80\Polyfill::substr($str, $bLength + 1, -1), '"', $parseUnicodeEscape);
        }
    }
    /**
     * @internal
    ...
    public static function parseEscapeSequences(string $str, $quote, bool $parseUnicodeEscape = true) : string
    {
        ...
        return \preg_replace_callback('~\\\\([\\\\$nrtfve]|[xX][0-9a-fA-F]{1,2}|[0-7]{1,3}' . $extra . ')~', function ($matches) {
            ...
            if (isset(self::$replacements[$str])) {
                ...
                return \chr(\hexdec(\Phabel\Target\Php80\Polyfill::substr($str, 1)));
            } elseif ('u' === $str[0]) {
