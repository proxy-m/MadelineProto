...
final class HttpClientBuilder
{
    ...
    public function build() : HttpClient
    {
        ...
        if ($this->followRedirectsInterceptor) {
            \Phabel\Target\Php73\Polyfill::array_unshift($applicationInterceptors, $this->followRedirectsInterceptor);
        }
        if ($this->forbidUriUserInfo) {
            \Phabel\Target\Php73\Polyfill::array_unshift($applicationInterceptors, $this->forbidUriUserInfo);
        }
