...
final class Redis
{
    ...
    {
        \Phabel\Target\Php73\Polyfill::array_unshift($keys, $key);
    ...
    {
        $this->evalCache = [];
        // same as internal redis behavior
     ...
     */
    public function eval(string $script, array $keys = array(), array $args = array()) : Promise
    {
