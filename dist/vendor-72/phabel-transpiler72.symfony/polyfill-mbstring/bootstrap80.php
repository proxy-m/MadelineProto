...
if (!function_exists('mb_convert_encoding')) {
    ...
    {
        if (!(\is_array($string) || \is_string($string) || \is_null($string))) {
        ...
        if (!(\is_array($from_encoding) || \is_string($from_encoding) || \is_null($from_encoding) || \is_null($from_encoding))) {
        ...
        if (!(\is_array($phabelReturn) || \is_string($phabelReturn) || $phabelReturn === false)) {
...
if (!function_exists('mb_check_encoding')) {
    ...
    {
        if (!(\is_array($value) || \is_string($value) || \is_null($value) || \is_null($value))) {
...
if (!function_exists('mb_detect_encoding')) {
    ...
    {
        if (!(\is_array($encodings) || \is_string($encodings) || \is_null($encodings) || \is_null($encodings))) {
...
if (!function_exists('mb_detect_order')) {
    ...
    {
        if (!(\is_array($encoding) || \is_string($encoding) || \is_null($encoding) || \is_null($encoding))) {
        ...
        if (!(\is_array($phabelReturn) || \is_bool($phabelReturn))) {
            if (!(\is_bool($phabelReturn) || \is_numeric($phabelReturn) || \is_string($phabelReturn))) {
...
if (!function_exists('mb_strpos')) {
    ...
    function mb_strpos(?string $haystack, ?string $needle, ?int $offset = 0, ?string $encoding = null)
    {
        ...
        if (!(\is_int($phabelReturn) || $phabelReturn === false)) {
...
if (!function_exists('mb_substitute_character')) {
    /**
     * @param (null | int | string) $substitute_character
     * @return (bool | int | string)
     */
    function mb_substitute_character($substitute_character = null)
    {
        if (!(\is_null($substitute_character) || \is_int($substitute_character) || \is_string($substitute_character) || \is_null($substitute_character))) {
            if (!(\is_string($substitute_character) || \is_object($substitute_character) && \method_exists($substitute_character, '__toString') || (\is_bool($substitute_character) || \is_numeric($substitute_character)))) {
                if (!(\is_bool($substitute_character) || \is_numeric($substitute_character))) {
                    throw new \TypeError(__METHOD__ . '(): Argument #1 ($substitute_character) must be of type ?null|int|string, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($substitute_character) . ' given, called in ' . \Phabel\Plugin\TypeHintReplacer::trace());
                } else {
        ...
        if (!(\is_bool($phabelReturn) || \is_int($phabelReturn) || \is_string($phabelReturn))) {
            if (!(\is_string($phabelReturn) || \is_object($phabelReturn) && \method_exists($phabelReturn, '__toString') || (\is_bool($phabelReturn) || \is_numeric($phabelReturn)))) {
                if (!(\is_bool($phabelReturn) || \is_numeric($phabelReturn))) {
                    if (!(\is_bool($phabelReturn) || \is_numeric($phabelReturn) || \is_string($phabelReturn))) {
                        throw new \TypeError(__METHOD__ . '(): Return value must be of type bool|int|string, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($phabelReturn) . ' returned in ' . \Phabel\Plugin\TypeHintReplacer::trace());
                    } else {
                        $phabelReturn = (bool) $phabelReturn;
                    }
                } else {
...
if (!function_exists('mb_get_info')) {
    ...
    function mb_get_info(?string $type = 'all')
    {
        ...
        if (!(\is_array($phabelReturn) || \is_int($phabelReturn) || \is_string($phabelReturn) || $phabelReturn === false)) {
            if (!(\is_string($phabelReturn) || \is_object($phabelReturn) && \method_exists($phabelReturn, '__toString') || (\is_bool($phabelReturn) || \is_numeric($phabelReturn)))) {
                if (!(\is_bool($phabelReturn) || \is_numeric($phabelReturn))) {
                    throw new \TypeError(__METHOD__ . '(): Return value must be of type false|array|int|string, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($phabelReturn) . ' returned in ' . \Phabel\Plugin\TypeHintReplacer::trace());
                } else {
                    $phabelReturn = (int) $phabelReturn;
                }
            } else {
...
if (!function_exists('mb_convert_variables')) {
    ...
    {
        if (!(\is_array($from_encoding) || \is_string($from_encoding) || \is_null($from_encoding))) {
            if (!(\is_string($from_encoding) || \is_object($from_encoding) && \method_exists($from_encoding, '__toString') || (\is_bool($from_encoding) || \is_numeric($from_encoding)))) {
