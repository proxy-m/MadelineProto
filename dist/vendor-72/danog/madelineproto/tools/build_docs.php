...
foreach ($orderedfiles as $key => $filename) {
    ...
    \Phabel\Target\Php73\Polyfill::array_unshift($lines, '---', 'title: "' . $title . '"', 'description: "' . $description . '"', 'nav_order: ' . ($key + 4), 'image: https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png', '---');
