...
class Logger
{
     ...
     */
    const FOREGROUND = array('default' => 39, 'black' => 30, 'red' => 31, 'green' => 32, 'yellow' => 33, 'blue' => 34, 'magenta' => 35, 'cyan' => 36, 'light_gray' => 37, 'dark_gray' => 90, 'light_red' => 91, 'light_green' => 92, 'light_yellow' => 93, 'light_blue' => 94, 'light_magenta' => 95, 'light_cyan' => 96, 'white' => 97);
    /**
     * @internal ANSI background color escapes
     */
    const BACKGROUND = array('default' => 49, 'black' => 40, 'red' => 41, 'magenta' => 45, 'yellow' => 43, 'green' => 42, 'blue' => 44, 'cyan' => 46, 'light_gray' => 47, 'dark_gray' => 100, 'light_red' => 101, 'light_green' => 102, 'light_yellow' => 103, 'light_blue' => 104, 'light_magenta' => 105, 'light_cyan' => 106, 'white' => 107);
    /**
     * @internal ANSI modifier escapes
     */
    const SET = array('bold' => 1, 'dim' => 2, 'underlined' => 3, 'blink' => 4, 'reverse' => 5, 'hidden' => 6);
    /**
     * @internal ANSI reset modifier escapes
     */
    const RESET = array('all' => 0, 'bold' => 21, 'dim' => 22, 'underlined' => 24, 'blink' => 25, 'reverse' => 26, 'hidden' => 28);
    /**
     * Logging mode.
     *
     * @var integer
     ...
     * @return void
     */
    public static function log($param, int $level = 3)
    {
    ...
    public function logger($param, int $level = 3, string $file = '') : void
    {
        ...
        if (Magic::$suspendPeriodicLogging) {
            Magic::$suspendPeriodicLogging->promise()->onResolve(function () use($param, $level, $file) {
                return $this->logger($param, $level, $file);
            });
            return;
        }
        if (!self::$printed) {
