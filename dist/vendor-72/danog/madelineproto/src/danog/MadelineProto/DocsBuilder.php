...
class DocsBuilder
{
    const DEFAULT_TEMPLATES = array('User' => array(0 => 'User', 1 => 'InputUser', 2 => 'Chat', 3 => 'InputChannel', 4 => 'Peer', 5 => 'InputDialogPeer', 6 => 'DialogPeer', 7 => 'InputPeer', 8 => 'NotifyPeer', 9 => 'InputNotifyPeer'), 'ReplyMarkup' => array(0 => 'ReplyMarkup'), 'InputFile' => array(0 => 'InputFile', 1 => 'InputEncryptedFile'), 'InputEncryptedChat' => array(0 => 'InputEncryptedChat'), 'PhoneCall' => array(0 => 'PhoneCall'), 'InputPhoto' => array(0 => 'InputPhoto'), 'InputDocument' => array(0 => 'InputDocument'), 'InputMedia' => array(0 => 'InputMedia'), 'InputMessage' => array(0 => 'InputMessage'), 'KeyboardButton' => array(0 => 'KeyboardButton'));
    ...
    protected $TL;
    /**
     * @var array $tdDescriptions
     */
    protected $tdDescriptions;
    /**
     *
     */
