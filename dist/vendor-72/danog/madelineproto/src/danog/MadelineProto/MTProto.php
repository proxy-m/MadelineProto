...
class MTProto extends AsyncConstruct implements TLCallback
{
    ...
    private const RSA_KEYS = array(0 => '-----BEGIN RSA PUBLIC KEY-----
...
-----END RSA PUBLIC KEY-----');
    private const TEST_RSA_KEYS = array(0 => '-----BEGIN RSA PUBLIC KEY-----
...
-----END RSA PUBLIC KEY-----');
     ...
     * @internal
     */
    const TD_PARAMS_CONVERSION = array('updateNewMessage' => array('_' => 'updateNewMessage', 'disable_notification' => array(0 => 'message', 1 => 'silent'), 'message' => array(0 => 'message')), 'message' => array('_' => 'message', 'id' => array(0 => 'id'), 'sender_user_id' => array(0 => 'from_id'), 'chat_id' => array(0 => 'peer_id', 1 => 'choose_chat_id_from_botapi'), 'send_state' => array(0 => 'choose_incoming_or_sent'), 'can_be_edited' => array(0 => 'choose_can_edit'), 'can_be_deleted' => array(0 => 'choose_can_delete'), 'is_post' => array(0 => 'post'), 'date' => array(0 => 'date'), 'edit_date' => array(0 => 'edit_date'), 'forward_info' => array(0 => 'fwd_info', 1 => 'choose_forward_info'), 'reply_to_message_id' => array(0 => 'reply_to_msg_id'), 'ttl' => array(0 => 'choose_ttl'), 'ttl_expires_in' => array(0 => 'choose_ttl_expires_in'), 'via_bot_user_id' => array(0 => 'via_bot_id'), 'views' => array(0 => 'views'), 'content' => array(0 => 'choose_message_content'), 'reply_markup' => array(0 => 'reply_markup')), 'messages.sendMessage' => array('chat_id' => array(0 => 'peer'), 'reply_to_message_id' => array(0 => 'reply_to_msg_id'), 'disable_notification' => array(0 => 'silent'), 'from_background' => array(0 => 'background'), 'input_message_content' => array(0 => 'choose_message_content'), 'reply_markup' => array(0 => 'reply_markup')));
    /**
     * @internal
     */
    const TD_REVERSE = array('sendMessage' => 'messages.sendMessage');
    /**
     * @internal
     */
    const TD_IGNORE = array(0 => 'updateMessageID');
    /**
     ...
     * @internal
     */
    const BOTAPI_PARAMS_CONVERSION = array('disable_web_page_preview' => 'no_webpage', 'disable_notification' => 'silent', 'reply_to_message_id' => 'reply_to_msg_id', 'chat_id' => 'peer', 'text' => 'message');
    /**
     * @internal
     */
    const DEFAULT_GETUPDATES_PARAMS = array('offset' => 0, 'limit' => NULL, 'timeout' => 100);
    /**
    ...
    */
    ...
    /**
     * TOS check loop.
     * @var (PeriodicLoopInternal | null) $checkTosLoop
     */
    public $checkTosLoop = null;
    /**
     * Phone config loop.
     * @var (PeriodicLoopInternal | null) $phoneConfigLoop
     */
    public $phoneConfigLoop = null;
    /**
     * Config loop.
     * @var (PeriodicLoopInternal | null) $configLoop
     */
    public $configLoop = null;
    /**
     * Call checker loop.
     * @var (PeriodicLoopInternal | null) $callCheckerLoop
     */
    private $callCheckerLoop = null;
    /**
     * Autoserialization loop.
     * @var (PeriodicLoopInternal | null) $serializeLoop
     */
    private $serializeLoop = null;
    /**
     * SEQ update loop.
     * @var (SeqLoop | null) $seqUpdater
     */
    private $seqUpdater = null;
    /**
     * IPC server.
     * @var (Server | null) $ipcServer
     */
    private $ipcServer = null;
    /**
     * Feeder loops.
     *
     ...
     * @var array
     */
    protected static $dbProperties = ['chats' => 'array', 'full_chats' => 'array', 'sponsoredMessages' => 'array', 'channelParticipants' => 'array', 'usernames' => 'array', 'session' => ['type' => 'array', 'config' => ['enableCache' => false]]];
    /**
     ...
     * @return void
     */
    public function logger($param, int $level = 3, string $file = '') : void
    {
        if ($file === null) {
    ...
    private function cleanupProperties() : \Generator
    {
        ...
        if (!isset($this->datacenter)) {
            $this->datacenter = $this->datacenter ?? new DataCenter($this, $this->dcList, $this->settings->getConnection());
        }
     ...
     * @return \Generator
     */
    public function getConfig(array $config = array(), array $options = array()) : \Generator
    {
