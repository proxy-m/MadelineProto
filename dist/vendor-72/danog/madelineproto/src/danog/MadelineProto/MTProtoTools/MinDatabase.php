...
class MinDatabase implements TLCallback
{
    ...
    const SWITCH_CONSTRUCTORS = array(0 => 'inputChannel', 1 => 'inputUser', 2 => 'inputPeerUser', 3 => 'inputPeerChannel');
    const CATCH_PEERS = array(0 => 'message', 1 => 'messageService', 2 => 'peerUser', 3 => 'peerChannel', 4 => 'messageEntityMentionName', 5 => 'messageFwdHeader', 6 => 'messageActionChatCreate', 7 => 'messageActionChatAddUser', 8 => 'messageActionChatDeleteUser', 9 => 'messageActionChatJoinedByLink');
    const ORIGINS = array(0 => 'message', 1 => 'messageService');
    /**
     ...
     *
     */
    public function addOrigin(array $data = array()) : void
    {
