...
class ResponseInfo
{
    ...
    private const NO_CACHE = array('Cache-Control' => array(0 => 'no-store, no-cache, must-revalidate, max-age=0', 1 => 'post-check=0, pre-check=0'), 'Pragma' => 'no-cache');
    /**
