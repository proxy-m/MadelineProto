...
class Server extends SignalLoop
{
     ...
     * @var (Deferred | null) $shutdownDeferred
     */
    private static $shutdownDeferred = null;
    /**
     * Boolean whether to shut down worker, if started.
     * @var bool $shutdownNow
     */
    private static $shutdownNow = false;
    /**
     * IPC server.
     * @var IpcServer $server
     */
    protected $server;
    /**
     * Callback IPC server.
     * @var ServerCallback $callback
     */
    private $callback;
    /**
     * IPC settings.
    ...
    {
        self::$shutdownDeferred = self::$shutdownDeferred ?? new Deferred();
