...
{
    private const CGI_VARS = array(0 => 'AUTH_TYPE', 1 => 'CONTENT_LENGTH', 2 => 'CONTENT_TYPE', 3 => 'GATEWAY_INTERFACE', 4 => 'PATH_INFO', 5 => 'PATH_TRANSLATED', 6 => 'QUERY_STRING', 7 => 'REMOTE_ADDR', 8 => 'REMOTE_HOST', 9 => 'REMOTE_IDENT', 10 => 'REMOTE_USER', 11 => 'REQUEST_METHOD', 12 => 'SCRIPT_NAME', 13 => 'SERVER_NAME', 14 => 'SERVER_PORT', 15 => 'SERVER_PROTOCOL', 16 => 'SERVER_SOFTWARE');
    ...
    public static function start(string $session, int $startupId) : Promise
    {
        ...
        $command = \array_merge(array($binary), self::formatOptions($options), array($runner, 'madeline-ipc', $session, $startupId));
        ...
        $envVars = \array_merge(\Phabel\Target\Php74\Polyfill::array_filter($_SERVER, function ($v, $k) : bool {
            return \is_string($v) && !\in_array($k, self::CGI_VARS);
        }, ARRAY_FILTER_USE_BOTH), ['QUERY_STRING' => \http_build_query($params)]);
