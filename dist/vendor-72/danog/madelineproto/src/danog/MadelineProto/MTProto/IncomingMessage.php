...
class IncomingMessage extends Message
{
     ...
     * Response field map.
     */
    private const RESPONSE_ID_MAP = array('rpc_result' => 'req_msg_id', 'future_salts' => 'req_msg_id', 'msgs_state_info' => 'req_msg_id', 'bad_server_salt' => 'bad_msg_id', 'bad_msg_notification' => 'bad_msg_id', 'pong' => 'msg_id');
    /**
     * State.
     * @var int $state
     */
    private $state = self::STATE_RECEIVED;
    /**
     * Receive date.
     * @var int $received
     */
