...
class OutgoingMessage extends Message
{
    ...
    /**
     * Resolution deferred.
     * @var (Deferred | null) $promise
     */
    private $promise = null;
    /**
     * Send deferred.
     * @var (Deferred | null) $sendPromise
     */
    private $sendPromise = null;
    /**
     * Whether this is an unencrypted message.
     * @var bool $unencrypted
     */
    private $unencrypted;
    /**
     * Message body.
    ...
    public function reply($result) : void
    {
        ...
        if ($this->promise) {
            ...
            $this->promise = null;
            Loop::defer(function () use($promise, $result) {
