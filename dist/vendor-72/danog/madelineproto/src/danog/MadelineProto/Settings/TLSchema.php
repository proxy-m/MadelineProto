...
class TLSchema extends SettingsAbstract
{
    ...
    /**
     * API schema path.
     * @var string $APISchema
     */
    protected $APISchema = __DIR__ . '/../TL_telegram_v143.tl';
    /**
     * MTProto schema path.
     * @var string $MTProtoSchema
     */
    protected $MTProtoSchema = __DIR__ . '/../TL_mtproto_v1.tl';
    /**
     * Secret schema path.
     * @var string $secretSchema
     */
    protected $secretSchema = __DIR__ . '/../TL_secret.tl';
    /**
     ...
     * @var bool $wasUpgraded
     */
    private $wasUpgraded = true;
    /**
     *
     */
