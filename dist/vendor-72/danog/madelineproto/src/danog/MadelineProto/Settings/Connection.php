...
class Connection extends SettingsAbstract
{
     ...
     * @var int $minMediaSocketCount
     */
    protected $minMediaSocketCount = 5;
    /**
     * Maximum media socket count.
     * @var int $maxMediaSocketCount
     */
    protected $maxMediaSocketCount = 10;
    /**
     * Robin period (seconds).
     * @var int $robinPeriod
     */
    protected $robinPeriod = 10;
    /**
     * Default DC ID.
     * @var int $defaultDc
     */
    protected $defaultDc = 2;
    /**
     * Default DC params.
     * @var array $defaultDcParams
     */
    private $defaultDcParams = ['datacenter' => 2];
    /**
     * Protocol identifier.
     *
     * @var class-string<MTProtoBufferInterface>
     */
    protected $protocol = AbridgedStream::class;
    /**
     * Transport identifier.
     *
     * @var class-string<RawStreamInterface>
     */
    protected $transport = DefaultStream::class;
    /**
     * Proxy identifiers.
     *
     ...
     * @var bool $useDoH
     */
    protected $useDoH = true;
    /**
     * Bind on specific address and port.
     * @var (string | null) $bindTo
     */
    private $bindTo = null;
    /**
     * Subdomains of web.telegram.org for https protocol.
     * @var array $sslSubdomains
     */
    protected $sslSubdomains = [1 => 'pluto', 2 => 'venus', 3 => 'aurora', 4 => 'vesta', 5 => 'flora'];
    /**
     *
     */
    ...
    * @return self
    */
    public function addProxy(string $proxy, array $extra = array()) : self
    {
