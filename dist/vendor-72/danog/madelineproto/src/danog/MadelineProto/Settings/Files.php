...
class Files extends SettingsAbstract
{
     ...
     * @var bool $allowAutomaticUpload
     */
    protected $allowAutomaticUpload = true;
    /**
     * Upload parallel chunk count.
     * @var int $uploadParallelChunks
     */
    protected $uploadParallelChunks = 20;
    /**
     * Download parallel chunk count.
     * @var int $downloadParallelChunks
     */
    protected $downloadParallelChunks = 20;
    /**
     * Whether to report undownloadable media to TSF.
     * @var bool $reportBrokenMedia
     */
    protected $reportBrokenMedia = true;
    /**
     *
     */
