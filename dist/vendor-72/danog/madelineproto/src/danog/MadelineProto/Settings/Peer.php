...
class Peer extends SettingsAbstract
{
     ...
     * @var int $fullInfoCacheTime
     */
    protected $fullInfoCacheTime = 60 * 60;
    /**
     * Should madeline fetch the full member list of every group it meets?
     * @var bool $fullFetch
     */
    protected $fullFetch = false;
    /**
     * Whether to cache all peers on startup for userbots.
     * @var bool $cacheAllPeersOnStartup
     */
    protected $cacheAllPeersOnStartup = false;
    /**
     *
     */
