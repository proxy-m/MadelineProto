...
class Ogg
{
     ...
     * @var int $frameDuration
     */
    private $frameDuration = 60000;
    /**
     ...
     * @var BufferInterface $stream
     */
    private $stream;
    /**
     * Pack format.
     * @var string $packFormat
     */
    private $packFormat;
    /**
     * OPUS packet emitter.
    ...
    public static function init(BufferedStreamInterface $stream, int $frameDuration) : \Generator
    {
        ...
        $self->packFormat = \implode('/', \array_map(function (string $v, string $k) : string {
            return $v . $k;
        }, $pack_format, \array_keys($pack_format)));
        return $self;
    }
    /**
     * Read OPUS length.
        ...
        while ($offset < $len) {
            ...
            if ($c === 0) {
                ...
                if ($vbr) {
                    ...
                    \Phabel\Target\Php73\Polyfill::array_push($sizes, ...\array_fill(0, $count, $size));
                }
            }
