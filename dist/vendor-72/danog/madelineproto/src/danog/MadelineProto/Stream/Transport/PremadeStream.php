...
class PremadeStream implements RawStreamInterface, ProxyStreamInterface
{
    ...
    public function getSocket()
    {
        ...
        if (!$phabelReturn instanceof Socket) {
            throw new \TypeError(__METHOD__ . '(): Return value must be of type Socket, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($phabelReturn) . ' returned in ' . \Phabel\Plugin\TypeHintReplacer::trace());
        }
        return $phabelReturn;
    }
    /**
