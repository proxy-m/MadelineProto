...
class HashedBufferedStream implements BufferedProxyStreamInterface, BufferInterface
{
    ...
    public function getSocket()
    {
        ...
        if (!$phabelReturn instanceof \Amp\Socket\Socket) {
            throw new \TypeError(__METHOD__ . '(): Return value must be of type Amp\\Socket\\Socket, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($phabelReturn) . ' returned in ' . \Phabel\Plugin\TypeHintReplacer::trace());
        }
        return $phabelReturn;
    }
    /**
