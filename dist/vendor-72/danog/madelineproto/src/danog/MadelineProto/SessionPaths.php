...
class SessionPaths
{
    /**
     * Legacy session path.
     * @var string $legacySessionPath
     */
    private $legacySessionPath;
    /**
     * Session path.
     ...
     * @var string $ipcCallbackPath
     */
    private $ipcCallbackPath;
    /**
     * IPC light state path.
     * @var string $ipcStatePath
     */
    private $ipcStatePath;
    /**
     * Light state path.
     * @var string $lightStatePath
     */
    private $lightStatePath;
    /**
     * Light state.
     * @var (LightState | null) $lightState
     */
    private $lightState = null;
    /**
