...
{
    /**
     * @var (string | null) $tmpDbPrefix
     */
    public $tmpDbPrefix = null;
    /**
    ...
    private static function getSessionId(MTProto $madelineProto) : string
    {
        ...
        if (!$result) {
            $madelineProto->tmpDbPrefix = $madelineProto->tmpDbPrefix ?? 'tmp_' . \str_replace('0', '', \spl_object_hash($madelineProto));
