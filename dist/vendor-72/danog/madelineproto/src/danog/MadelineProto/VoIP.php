...
class VoIP
{
    ...
    /**
     * @var MTProto $MadelineProto
     */
    private $MadelineProto;
    /**
     * @var MTProto $madeline
     */
    public $madeline;
    ...
    private $creator;
    /**
     * @var PermAuthKey $authKey
     */
    private $authKey;
    /**
     * @var int $peerVersion
     */
    private $peerVersion = 0;
    /**
     * @var Endpoint[]
     */
    private $sockets = [];
     ...
     * @var array $tempHoldFiles
     */
    private $tempHoldFiles = [];
    /**
     * Sleep function.
     *
     * @return array
     ...
     * @return (self | false)
     */
    public function discard($reason = array('_' => 'phoneCallDiscardReasonDisconnect'), $rating = array(), $debug = false)
    {
