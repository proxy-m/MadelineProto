...
class SecretHandler extends \danog\MadelineProto\EventHandler
{
    ...
    /**
     *
     * @param (APIWrapper | null) $API
     */
    public function __construct($API)
    {
        if (!($API instanceof APIWrapper || \is_null($API))) {
            throw new \TypeError(__METHOD__ . '(): Argument #1 ($API) must be of type ?APIWrapper, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($API) . ' given, called in ' . \Phabel\Plugin\TypeHintReplacer::trace());
        }
