...
class TripleDES extends DES
{
    ...
    public function setKey($key)
    {
        ...
        switch (strlen($key)) {
            case 16:
                $key .= \Phabel\Target\Php80\Polyfill::substr($key, 0, 8);
                break;
            case 24:
                break;
            default:
        ...
        $this->setEngine();
        if ($this->mode_3cbc) {
            $this->des[0]->setKey(\Phabel\Target\Php80\Polyfill::substr($key, 0, 8));
            $this->des[1]->setKey(\Phabel\Target\Php80\Polyfill::substr($key, 8, 8));
            $this->des[2]->setKey(\Phabel\Target\Php80\Polyfill::substr($key, 16, 8));
        }
    }
    /**
     * Encrypts a message.
