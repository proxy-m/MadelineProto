    ...
    public static function load($key, $password = '')
    {
        switch (strlen($key)) {
            case 32:
                ...
                break;
            case 64:
                $private = \Phabel\Target\Php80\Polyfill::substr($key, 0, 32);
                $public = \Phabel\Target\Php80\Polyfill::substr($key, -32);
                break;
            case 96:
                $public = \Phabel\Target\Php80\Polyfill::substr($key, -32);
                if (\Phabel\Target\Php80\Polyfill::substr($key, 32, 32) != $public) {
