...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct($mailer, $message, $level = 400, bool $bubble = true)
    {
        if (!$mailer instanceof \Swift_Mailer) {
            throw new \TypeError(__METHOD__ . '(): Argument #1 ($mailer) must be of type Swift_Mailer, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($mailer) . ' given, called in ' . \Phabel\Plugin\TypeHintReplacer::trace());
        }
