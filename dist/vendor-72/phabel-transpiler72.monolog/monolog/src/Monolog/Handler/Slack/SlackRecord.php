...
class SlackRecord
{
    ...
    */
    ...
    public function stringify(array $fields) : string
    {
        ...
        $hasSecondDimension = count(\Phabel\Target\Php74\Polyfill::array_filter($normalized, 'is_array'));
        $hasNonNumericKeys = !count(\Phabel\Target\Php74\Polyfill::array_filter(array_keys($normalized), 'is_numeric'));
     ...
     * @param string[] $excludeFields
     */
    public function excludeFields(array $excludeFields = array()) : self
    {
