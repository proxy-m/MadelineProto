...
class RollbarHandler extends AbstractProcessingHandler
{
     ...
     */
    public function __construct($rollbarLogger, $level = 400, bool $bubble = true)
    {
        if (!$rollbarLogger instanceof RollbarLogger) {
            throw new \TypeError(__METHOD__ . '(): Argument #1 ($rollbarLogger) must be of type RollbarLogger, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($rollbarLogger) . ' given, called in ' . \Phabel\Plugin\TypeHintReplacer::trace());
        }
