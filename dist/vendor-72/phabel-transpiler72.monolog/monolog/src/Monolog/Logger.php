...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     */
    private const RFC_5424_LEVELS = array(7 => 100, 6 => 200, 5 => 250, 4 => 300, 3 => 400, 2 => 500, 1 => 550, 0 => 600);
    /**
     * @var string
     */
    protected $name;
    ...
    {
        \Phabel\Target\Php73\Polyfill::array_unshift($this->handlers, $handler);
        return $this;
    }
    /**
    ...
    {
        \Phabel\Target\Php73\Polyfill::array_unshift($this->processors, $callback);
        return $this;
    }
    /**
