...
class Certificate
{
    ...
    public function getNames()
    {
        ...
        foreach ($parts as $part) {
            if (stripos($part, "dns:") === 0) {
                $names[] = \Phabel\Target\Php80\Polyfill::substr($part, 4);
            }
        }
    ...
    {
        return ["commonName" => $this->getSubject()->getCommonName(), "names" => $this->getNames(), "issuedBy" => $this->getIssuer()->getCommonName(), "validFrom" => \Phabel\Target\Php80\Polyfill::date("d.m.Y", $this->getValidFrom()), "validTo" => \Phabel\Target\Php80\Polyfill::date("d.m.Y", $this->getValidTo())];
    }
    /**
     *
     */
