...
class IPv6Address extends Type
{
    ...
    private function createCompressedString($shorts)
    {
        ...
        if ($compressLen > 1) {
            ...
            \Phabel\Target\Php74\Polyfill::array_splice($shorts, $compressPos, $compressLen, $replace);
        }
            ...
            if ($shorts[0] === '' && $shorts[1] === '') {
                ...
                if ($shorts[$count - 2] === '' && $shorts[$count - 1] === '') {
                    ...
                    if (false !== ($pos = \array_search('', $shorts, true))) {
                        \Phabel\Target\Php74\Polyfill::array_splice($shorts, $pos, 1, \array_fill(0, 8 - ($count - 1), '0'));
                    }
                }
            }
        }
