...
final class Expression
{
     ...
     */
    private const OPERATOR_HASH_LOOKUP = array('' => array('prefix' => '', 'joiner' => ',', 'query' => false), '+' => array('prefix' => '', 'joiner' => ',', 'query' => false), '#' => array('prefix' => '#', 'joiner' => ',', 'query' => false), '.' => array('prefix' => '.', 'joiner' => '.', 'query' => false), '/' => array('prefix' => '/', 'joiner' => '/', 'query' => false), ';' => array('prefix' => ';', 'joiner' => ';', 'query' => true), '?' => array('prefix' => '?', 'joiner' => '&', 'query' => true), '&' => array('prefix' => '&', 'joiner' => '&', 'query' => true));
    /**
     * @var string $operator
     */
    private $operator;
    ...
    {
        return array_unique(array_map(static function (VarSpecifier $varSpecifier) : string {
    ...
    {
        $varSpecifierString = implode(',', array_map(static function (VarSpecifier $variable) : string {
    ...
    public function expand(VariableBag $variables) : string
    {
        ...
        $expanded = implode($this->joiner, \Phabel\Target\Php74\Polyfill::array_filter($parts, static function ($value) : bool {
            return '' !== $value;
        }));
        if ('' === $expanded) {
            return $expanded;
    ...
    {
        if (':' === $varSpec->modifier()) {
            $value = \Phabel\Target\Php80\Polyfill::substr($value, 0, $varSpec->position());
        }
