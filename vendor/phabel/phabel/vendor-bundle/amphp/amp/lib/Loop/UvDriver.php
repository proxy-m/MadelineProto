...
use function PhabelVendor\Amp\Promise\rethrow;
            ...
            switch ($watcher->type) {
                ...
                case Watcher::WRITABLE:
                    ...
                    if (isset($this->streams[$streamId])) {
                        ...
                        $event = $this->streams[$streamId] = \PhabelVendor\uv_poll_init_socket($this->handle, $watcher->value);
                    }
                    $eventId = (int) $event;
                ...
                case Watcher::SIGNAL:
                    ...
                    if (isset($this->events[$id])) {
                        ...
                        /** @psalm-suppress UndefinedFunction */
                        $event = $this->events[$id] = \PhabelVendor\uv_signal_init($this->handle);
                    }
                    $this->watchers[(int) $event] = [$watcher];
                    /** @psalm-suppress UndefinedFunction */
                    \PhabelVendor\uv_signal_start($event, $this->signalCallback, $watcher->value);
                    break;
                default:
