 ...
 */
namespace PhabelVendor\Symfony\Component\Console\Completion;
    ...
    public function bind(InputDefinition $definition) : void
    {
        ...
        if ('-' === $relevantToken[0]) {
            ...
            if (null !== $option && $option->acceptValue()) {
                ...
                $this->completionValue = $optionValue ?: (!\str_starts_with($optionToken, '--') ? \Phabel\Target\Php80\Polyfill::substr($optionToken, 2) : '');
                return;
            }
        }
