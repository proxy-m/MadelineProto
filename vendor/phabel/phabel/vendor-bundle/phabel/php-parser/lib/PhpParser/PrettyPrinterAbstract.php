...
use PhabelVendor\PhpParser\Internal\DiffElem;
use PhabelVendor\PhpParser\Internal\PrintableNewAnonClassNode;
use PhabelVendor\PhpParser\Internal\TokenStream;
