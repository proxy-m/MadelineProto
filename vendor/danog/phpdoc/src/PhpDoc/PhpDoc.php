...
class PhpDoc
{
    ...
    public function run() : self
    {
        ...
        foreach ($classList as $class) {
            ...
            $reflectionClass = \function_exists($class) ? new ReflectionFunction($class) : new ReflectionClass($class);
            $class = $reflectionClass instanceof ReflectionFunction ? new FunctionDoc($this, $reflectionClass) : new ClassDoc($this, $reflectionClass);
