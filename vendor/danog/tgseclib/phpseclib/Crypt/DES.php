...
class DES extends BlockCipher
{
     ...
     * @access private
     */
    protected static $sbox4 = [2151682048.0, 2147487808.0, 2147487808.0, 0x40, 0x401040, 2151678016.0, 2151677952.0, 2147487744.0, 0x0, 0x401000, 0x401000, 2151682112.0, 2147483712.0, 0x0, 0x400040, 2151677952.0, 2147483648.0, 0x1000, 0x400000, 2151682048.0, 0x40, 0x400000, 2147487744.0, 0x1040, 2151678016.0, 2147483648.0, 0x1040, 0x400040, 0x1000, 0x401040, 2151682112.0, 2147483712.0, 0x400040, 2151677952.0, 0x401000, 2151682112.0, 2147483712.0, 0x0, 0x0, 0x401000, 0x1040, 0x400040, 2151678016.0, 2147483648.0, 2151682048.0, 2147487808.0, 2147487808.0, 0x40, 2151682112.0, 2147483712.0, 2147483648.0, 0x1000, 2151677952.0, 2147487744.0, 0x401040, 2151678016.0, 2147487744.0, 0x1040, 0x400000, 2151682048.0, 0x40, 0x400000, 0x1000, 0x401040];
    /**
     * Pre-permuted S-box5
     *
     * @var array
    ...
    protected function setupKey()
    {
        ...
        for ($des_round = 0; $des_round < $this->des_rounds; ++$des_round) {
            ...
            for ($i = 0, $ki = 31; $i < 16; ++$i, $ki -= 2) {
                ...
                $val1 = $cp & 4278190080.0 | $cp << 8 & 0xff0000 | $dp >> 16 & 0xff00 | $dp >> 8 & 0xff;
                $val2 = $cp << 8 & 4278190080.0 | $cp << 16 & 0xff0000 | $dp >> 8 & 0xff00 | $dp & 0xff;
