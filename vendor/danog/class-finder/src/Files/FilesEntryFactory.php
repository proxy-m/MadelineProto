...
class FilesEntryFactory
{
    ...
    private function findPHP()
    {
        ...
        if (!isset($php)) {
            throw new ClassFinderException(sprintf('Could not locate PHP interrupter. See "%s" for details.', 'https://gitlab.com/hpierce1102/ClassFinder/blob/master/docs/exceptions/filesCouldNotLocatePHP.md'));
        }
        return $php;
    }
}