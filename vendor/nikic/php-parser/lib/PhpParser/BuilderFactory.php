...
class BuilderFactory
{
     ...
     */
    public function attribute($name, array $args = array()) : Node\Attribute
    {
     ...
     */
    public function funcCall($name, array $args = array()) : Expr\FuncCall
    {
     ...
     */
    public function methodCall(Expr $var, $name, array $args = array()) : Expr\MethodCall
    {
     ...
     */
    public function staticCall($class, $name, array $args = array()) : Expr\StaticCall
    {
     ...
     * @return Expr\New_
     */
    public function new($class, array $args = array()) : Expr\New_
    {
