...
final class Text
{
     ...
     * @var string
     */
    private const COLOR_GREEN = '[30;42m';
    /**
     * @var string
     */
    private const COLOR_YELLOW = '[30;43m';
    /**
     * @var string
     */
    private const COLOR_RED = '[37;41m';
    /**
     * @var string
     */
    private const COLOR_HEADER = '[1;37;40m';
    /**
     * @var string
     */
    private const COLOR_RESET = '[0m';
    /**
     * @var string
     */
    private const COLOR_EOL = '[2K';
    /**
     * @var int
     */
