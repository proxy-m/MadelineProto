...
final class CodeCoverage
{
     ...
     */
    public function stop(bool $append = true, $linesToBeCovered = array(), array $linesToBeUsed = array()) : RawCodeCoverageData
    {
     ...
     */
    public function append(RawCodeCoverageData $rawData, $id = NULL, bool $append = true, $linesToBeCovered = array(), array $linesToBeUsed = array()) : void
    {
        if ($id === null) {
            $id = $this->currentId;
        }
