...
class CliTestDoxPrinter extends TestDoxPrinter
{
     ...
     */
    private const PREFIX_SIMPLE = array('default' => '│', 'start' => '│', 'message' => '│', 'diff' => '│', 'trace' => '│', 'last' => '│');
    /**
     * Colored Testdox use box-drawing for a more textured map of the message.
     */
    private const PREFIX_DECORATED = array('default' => '│', 'start' => '┐', 'message' => '├', 'diff' => '┊', 'trace' => '╵', 'last' => '┴');
    private const SPINNER_ICONS = array(0 => ' [36m◐[0m running tests', 1 => ' [36m◓[0m running tests', 2 => ' [36m◑[0m running tests', 3 => ' [36m◒[0m running tests');
