...
class DefaultResultPrinter extends Printer implements ResultPrinter
{
    ...
    public const COLOR_DEFAULT = 'never';
    private const AVAILABLE_COLORS = array(0 => 'never', 1 => 'auto', 2 => 'always');
    /**
     * @var int
     */
    protected $column = 0;
     ...
     * @throws Exception
     */
    public function __construct($out = NULL, bool $verbose = false, string $colors = 'never', bool $debug = false, $numberOfColumns = 80, bool $reverse = false)
    {
