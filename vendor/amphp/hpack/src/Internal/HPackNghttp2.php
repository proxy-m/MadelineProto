...
{
    private const FLAG_NO_INDEX = 1;
    private const FLAG_NO_COPY_NAME = 2;
    private const FLAG_NO_COPY_VALUE = 4;
    private const FLAG_NO_COPY = 6;
    private const FLAG_NO_COPY_SENSITIVE = 7;
    private const SENSITIVE_HEADERS = array('authorization' => 7, 'cookie' => 7, 'proxy-authorization' => 7, 'set-cookie' => 7);
    private static $ffi;
