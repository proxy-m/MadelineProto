...
class ErrorHandler
{
     ...
     * @return ErrorHandler
     */
    public static function register(LoggerInterface $logger, $errorLevelMap = array(), $exceptionLevelMap = array(), $fatalLevel = NULL) : self
    {
     ...
     * @return $this
     */
    public function registerExceptionHandler(array $levelMap = array(), bool $callPrevious = true) : self
    {
     ...
     * @return $this
     */
    public function registerErrorHandler(array $levelMap = array(), bool $callPrevious = true, int $errorTypes = -1, bool $handleOnlyReportedErrors = true) : self
    {
     ...
     * @param mixed[] $context
     */
    public function handleError(int $code, string $message, string $file = '', int $line = 0, ?array $context = array()) : bool
    {
