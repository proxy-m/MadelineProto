...
class ProcessHandler extends AbstractProcessingHandler
{
     ...
     */
    protected const DESCRIPTOR_SPEC = array(0 => array(0 => 'pipe', 1 => 'r'), 1 => array(0 => 'pipe', 1 => 'w'), 2 => array(0 => 'pipe', 1 => 'w'));
    /**
     ...
     */
    public function __construct(string $command, $level = 100, bool $bubble = true, ?string $cwd = NULL)
    {
        if ($command === '') {
