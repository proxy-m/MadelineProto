...
class LogmaticHandler extends SocketHandler
{
     ...
     */
    public function __construct(string $token, string $hostname = '', string $appname = '', bool $useSSL = true, $level = 100, bool $bubble = true, bool $persistent = false, float $timeout = 0.0, float $writingTimeout = 10.0, ?float $connectionTimeout = NULL, ?int $chunkSize = NULL)
    {
